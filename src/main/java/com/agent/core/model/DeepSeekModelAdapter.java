 ...
 */
@Slf4j
public class DeepSeekModelAdapter implements ChatModel {
    ...
    public DeepSeekModelAdapter(String apiKey) {
        this(apiKey, "deepseek-chat", "https://api.deepseek.com");
    }

    public DeepSeekModelAdapter(String apiKey, String model, String baseUrl) {
        this.apiKey = apiKey;
        this.model = model;
    ...
    private List<Map<String, String>> toDeepSeekMessages(List<Memory.Message> messages) {
